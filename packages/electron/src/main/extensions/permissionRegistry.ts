...
const CATALOG: readonly PermissionDescriptor[] = [
  ...
  },
  {
    ...
    label: 'Read Distill database',
    description: "Read Distill's local PGLite store (sessions, documents, trackers).",
    risk: 'high',
  },
  {
    id: 'nimbalyst-database-write',
    label: 'Write Distill database',
    description: "Modify Distill's local PGLite store. Can change sessions, documents, trackers.",
    risk: 'high',
  },
  {
    id: 'secrets-read',
